<template>
    <section id="auth" class="auth">
        ...
        <fl-header-simple></fl-header-simple>
                    ...
                    <section class="content-body">
                        ...
                        <el-row class="content-action">
                            <el-col :span="24" style="text-align: right;">
                                <el-link style="margin-right: 10px; font-size: 1.5rem;" :underline="false" type="info" v-routers:push="'/auth/reset-password'">忘记密码</el-link>
                                <el-link style="margin-right: 10px; font-size: 1.5rem;" :underline="false" type="info" v-routers:push="'/auth/register'">注册</el-link>
                            </el-col>
                        </el-row>
                    </section>
                </div>
